...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=15398625&assignment_repo_type=AssignmentRepo)
...
1. Go to the _to-do-list_ directory, if this is the first time running the front-end for this week execute the following:
...
2. Start the front end by running the following command in the _to-do-list_ directory:

```
    npm start
```

3. Open _another_ terminal or command window and go to the _to-do-list/backend_ directory and run the backend:
...
_Note for this section you'll need an IBM Cloud account, so this might be something to try in later weeks when you will provision IBM Cloud accounts_
